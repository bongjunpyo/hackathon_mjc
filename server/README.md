...
|---|---:|---:|
| OFF (1차 생성만) | 41 / 152 | 27.0% |
| **ON (최대 3회)** | **150 / 152** | **98.7%** |

시나리오 152개 = 34개 학과 × 목표 직무 × 재학 시점 2종(1학년 1학기 / 2학년 1학기).
남은 미달 2건은 드론정보공학과로, 개설 전공 과목이 43학점뿐이라(요건 45) 어떤
로드맵으로도 통과할 수 없는 실제 교육과정 공백이다.

**OFF일 때 미달 사유는 111건 전부 `major_credits`다.** 1차 생성이 목표 직무에
필요한 과목만 짜기 때문이고, 그 간극을 검증기가 잡아 채운다.
