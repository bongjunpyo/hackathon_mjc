...
| **4** | [로드맵 에이전트 (LLM 실연결)](#4-로드맵-에이전트-llm-실연결) | ✅ | 실 Claude API 25초 · `engine=llm` · `passed=True` |
...
| **8** | [검증 지표 · 문서](#8-검증-지표--문서) | ✅ | `metrics.py` 206 시나리오 · 11.2% → 99.0% |

테스트 **137개** 통과. 지표·명세는 [README](README.md) · [주요 기능](FEATURES.md) · [API 명세](API.md).
