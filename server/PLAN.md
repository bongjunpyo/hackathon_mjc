...
| | 단계 | 상태 | 컷 |
|---|---|---|---|
| **0** | [졸업요건 검증기](#0-졸업요건-검증기) | ✅ PR #11 (재리뷰 대기) | — |
| **1** | [카탈로그 로더](#1-카탈로그-로더) | ☐ | 22:00 |
| **2** | [재생성 루프](#2-재생성-루프) | ☐ | 22:00 |
| **3** | [FastAPI 표면](#3-fastapi-표면) | ☐ | 22:00 |
| **4** | [로드맵 에이전트 (LLM 실연결)](#4-로드맵-에이전트-llm-실연결) | ☐ | 02:00 |
| **5** | [실데이터 연결](#5-실데이터-연결) | ☐ | 05:00 |
| **6** | [트랙 B 정합도](#6-트랙-b-정합도) | ☐ | 07:00 |
| **7** | [인증 · DB](#7-인증--db-부가) | ☐ | 10:00 (컷 대상) |
| **8** | [검증 지표 · 문서](#8-검증-지표--문서) | ☐ | 10:00 |
