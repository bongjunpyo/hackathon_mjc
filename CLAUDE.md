...
- **한 줄 정의**: 운동 동아리 임원이 활동을 기록하고, 쌓인 기록으로 체중·칼로리 추이를 보는 웹앱.
- **데모 시나리오**: 샘플 데이터 생성 버튼으로 한 달치 기록을 채운 뒤, "8월 5일 한강 러닝 5km, 유산소, 45분, 12명"을 추가 등록하면 목록 맨 위에 뜨고, 통계 화면에서 월별 활동 횟수와 체중 추이가 갱신된다.
